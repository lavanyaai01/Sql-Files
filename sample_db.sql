...
(22,'Sangari S','','','1998-01-19',360158896738,58896738,9787264394,9751721397,9787264394,'TH2023F-C01E43E','Password@123','BE','ECE','NIL','NIL','2019','','sangarisaminathan@gmail.com','1/44 Agraharam North budalur Thanjavur (Dt) 613602','Thanjavur','Saminathan M','','Latha S');
...
select * from ai_batch_01 a1 left join system_details d1 on a1.SNO = d1.details_id;
